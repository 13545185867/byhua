...
public class JwWebJwidServiceImpl implements JwWebJwidService {
	...
	public List<JwWebJwid>  getByUsername(String username) {
		// TODO Auto-generated method stub
		return (List<JwWebJwid>)jwWebJwidnewDao.getByUsername(username);
	}

	@Override
	public JwWebJwid getByJWid(String username) {
		// TODO Auto-generated method stub
		return jwWebJwidnewDao.getByJWid(username);
	}

	@Override
	public JwWebJwid getByAPPid(String username) {
		// TODO Auto-generated method stub
		return jwWebJwidnewDao.getByAPPid(username);
	}
